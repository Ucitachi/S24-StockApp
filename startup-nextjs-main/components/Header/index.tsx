...
const Header = () => {
  ...
  //   try {
  //     setLoading(true);
  //     // Fetch both user data and authentication status
  //     const cookieValue = Cookies.get('token')

  //     if (cookieValue) {
  //       setToken(cookieValue); // Use server-side validation for security
  //     } else {
  //       setToken(null);
  //     }
  //   } catch (error) {
  ...
  useEffect(()=>{
    if(!token){
      setMenuDatas(menuData.filter((data)=>data.title!=="Dashboard"));
      return;
    }
                      ...
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            ...
                            } ${token && menuItem.path != '/dashboard'? '':'hidden'//Hide "Dashboard" for non-logged-in users
                          }`}
                          >
                            {menuItem.title}
                          </Link>
